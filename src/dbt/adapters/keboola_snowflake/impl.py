...
from dbt.adapters.keboola_snowflake import constants, parse_model
from dbt.adapters.keboola_snowflake.catalogs import (
    BuiltInCatalogIntegration,
    InfoSchemaCatalogIntegration,
    IcebergRestCatalogIntegration,
)
from dbt.adapters.keboola_snowflake.relation_configs import SnowflakeRelationType
...
class KeboolaSnowflakeAdapter(SQLAdapter):

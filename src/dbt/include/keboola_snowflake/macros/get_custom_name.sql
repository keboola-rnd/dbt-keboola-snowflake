{% macro keboola_snowflake__generate_database_name(custom_database_name=none, node=none) -%}
...
{% macro keboola_snowflake__generate_schema_name(custom_schema_name, node) -%}

...
{% macro keboola_snowflake__get_merge_sql(target, source_sql, unique_key, dest_columns, incremental_predicates) -%}
...
{% macro keboola_snowflake__get_delete_insert_merge_sql(target, source, unique_key, dest_columns, incremental_predicates) %}
...
{% macro keboola_snowflake__snapshot_merge_sql(target, source, insert_cols) %}
...
{% macro keboola_snowflake__get_incremental_append_sql(get_incremental_append_sql) %}
...
{% macro keboola_snowflake__get_incremental_microbatch_sql(arg_dict) %}

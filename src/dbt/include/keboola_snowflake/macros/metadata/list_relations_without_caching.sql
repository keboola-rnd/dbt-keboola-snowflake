{% macro keboola_snowflake__list_relations_without_caching(schema_relation, max_iter=10000, max_results_per_iter=10000) %}
    ...
    {%- for _ in range(max_iter + 1) -%}
        ...
        {%- set show_objects_sql = keboola_snowflake__show_objects_sql(schema, max_results_per_iter, paginated_state.watermark) -%}
...
{% macro keboola_snowflake__show_objects_sql(schema, max_results_per_iter=10000, watermark=none) %}

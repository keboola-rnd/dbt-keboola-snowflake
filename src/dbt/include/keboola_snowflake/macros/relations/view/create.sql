{% macro keboola_snowflake__create_view_as_with_temp_flag(relation, sql, is_temporary=False) -%}
...
{% macro keboola_snowflake__create_view_as(relation, sql) -%}
  {{ keboola_snowflake__create_view_as_with_temp_flag(relation, sql) }}
{% endmacro %}
...
{% macro keboola_snowflake__create_or_replace_view() %}
